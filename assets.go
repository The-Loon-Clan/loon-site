// Package site is the indexer's asset root, and nothing else.
//
...
// moved out: the HTTP layer to web/handlers, the command to cmd/loonsite.
//
...
// LOON_DEV=1 swaps in the working tree instead and makes render() re-parse
...
// production.
var DevReload = os.Getenv("LOON_DEV") == "1"
