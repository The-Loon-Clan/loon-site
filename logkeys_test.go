...
var logKeys = map[string]string{
	...
	"by":             "the user id who performed a staff action, as distinct from its subject",
	"ttl_hours":      "an invite's validity window, in hours",
	"email_required": "whether invites must name an email address",
