...
How other indexers attach metadata — the matching techniques, not the provider
list — is surveyed in [docs/METADATA-METHODS.md](docs/METADATA-METHODS.md).
...
- **Coverage is 34.2%** with the Postgres and Redis that CI provides, and
  **23.0%** on a laptop without them — the storage integration tests take that
